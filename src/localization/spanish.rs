...
pub(super) const STRINGS: Strings = Strings {
    ...
    second_suffix: "s",
    bar_style: "Estilo de barra",
    bar_theme_segmented: "Bloques segmentados",
    bar_theme_flat: "Plano minimalista",
    bar_theme_gradient: "Degradado",
    bar_theme_pixel: "Píxel retro",
    characters: "Personajes",
    show_characters: "Mostrar personajes",
    character_cat: "Gato",
    character_dog: "Perro",
    character_girl: "Chica",
    ...
    show_reset_timer: "Mostrar temporizador",
    cat_color: "Color del gato",
    dog_color: "Color del perro",
