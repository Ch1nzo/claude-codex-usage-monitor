...
pub(super) const STRINGS: Strings = Strings {
    ...
    second_suffix: "s",
    bar_style: "Style de barre",
    bar_theme_segmented: "Blocs segmentés",
    bar_theme_flat: "Plat minimal",
    bar_theme_gradient: "Dégradé lumineux",
    bar_theme_pixel: "Pixel rétro",
    characters: "Personnages",
    show_characters: "Afficher les personnages",
    character_cat: "Chat",
    character_dog: "Chien",
    character_girl: "Fille",
    ...
    cat_color: "Couleur du chat",
    dog_color: "Couleur du chien",
    color_orange: "Orange",
    color_grey: "Gris",
    color_brown: "Marron",
    color_black: "Noir",
    show_detailed_remaining: "Afficher le temps restant détaillé",
    show_pace_indicator: "Indicateur de rythme",
